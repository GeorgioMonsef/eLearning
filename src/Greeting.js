...
function Greeting() {
    ...
    return (
        <div className="relative isolate overflow-hidden bg-blue-500">
            ...
            <div className={`mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40 transition ${showSignup || showLearnMore ? 'blur-sm' : ''}`}>
            ...
            <div className="mx-auto max-w-7xl px-6 sm:px-8 py-8 bg-blue-500 text-white">
                <div className="text-left">
                    <h2 className="text-3xl font-bold mb-1">24/7 Support and Tutoring</h2>
                    <p className="text-left">
                        We offer round-the-clock support and tutoring services to help you with your educational needs. Whether you have questions late at night or need help preparing for exams, our team is here to assist you.
                    </p>
                </div>
            </div>
        </div>
